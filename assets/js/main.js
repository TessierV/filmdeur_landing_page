...
sr.reveal(`.sponsor__img, .categories__card, .footer__logo, .footer__copy`,{origin: 'top', interval: 100})
sr.reveal(`.specs__data, .teams__data, .discount__animate`,{origin: 'left', interval: 100})
sr.reveal(`.specs__img, .teams__img, .discount__img`,{origin: 'right'})
